...
#define FAN4_Pin GPIO_PIN_1
#define FAN4_GPIO_Port GPIOC
...
#define BRAKE_INB_GPIO_Port GPIOA
#define BRAKE_INA_Pin GPIO_PIN_7
#define BRAKE_INA_GPIO_Port GPIOA
#define IMU_INT1_Pin GPIO_PIN_4
#define IMU_INT1_GPIO_Port GPIOC
#define IMU_INT1_EXTI_IRQn EXTI4_IRQn
#define BRAKE_ENB_Pin GPIO_PIN_5
...
#define STAT3_GPIO_Port GPIOC
#define BRAKE_CS_Pin GPIO_PIN_7
